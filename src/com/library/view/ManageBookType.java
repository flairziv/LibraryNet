...
import com.library.controller.BookTypeController;
...
public class ManageBookType {
    ...
    protected JPanel addPanel1() throws SQLException {
        ...
        // 设置表格的公共属性
        TableUtils.setTable(table_bookType, dfttable_bookType);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    if (input_bookType != null && !input_bookType.equals("")) {
                        String regex = InputLimit.CHINESE_REGEX ;
                ...
                bt_id = TableUtils.cancelTableSelected(table_bookType, bt_id);
            }
        });
        // 删除图书类型
