...
public class ManageBook extends JPanel implements ActionListener, ItemListener {
    ...
    protected JPanel addPanel0() throws SQLException {
        ...
        dfttable_book = new DefaultTableModel(new PageQueryController(bookCon.selectBook()).setCurrentPageIndex(),
                columnNameBook);
        ...
        // 设置表格的公共属性
        TableUtils.setTable(table_book, dfttable_book);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // 新增图书
            ...
            TableUtils.cancelTableSelected(table_book, b_id);
        }
        // 删除图书
         ...
         */
        b_id = TableUtils.cancelTableSelected(table_book, b_id);
        // 尾页时，“下一页”和“尾页”按钮不可用
        if (pageIndex == pageCount) {
