...
public class ManageBorrowInfo {
    ...
    protected JPanel addPanel4() throws SQLException {
        ...
        jtext_borrow.addFocusListener(new InputLimit(jtext_borrow, "借阅证号"));// 设置文诓提示的外部类监听
        ...
        //设置表格的公共属性
        TableUtils.setTable(table_borrow, dfttableBorrow);
        ...
        jbt_borrow[0].addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    if (adm_count.equals("借阅证号") || adm_count.equals("")) {
                        JOptionPane.showMessageDialog(null, "请输入借阅证号！！！", "操作失败", JOptionPane.ERROR_MESSAGE);
                    } else {
